...
{	
	...
	public function show_dashboard_job()
	{
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Job Dashboard']),
			'page_title' => view('partials/page-title', ['title' => 'Job', 'pagetitle' => 'Dashboards'])
		];
		return view('Front/dashboard-job', $data);
	}
